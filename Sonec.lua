...
local Sonec = io.open("Sonec", 'w')
Sonec:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Sonec.lua
done
]])
Sonec:close()
...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./Sonec
done
]])
Run:close()
...
os.execute('chmod +x Sonec;chmod +x Run;./Run')
end
...
Sonec = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..Sonec)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Sonec,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,5292559122,5078690754,2083553704,1455001649}  
...
Status = 0
DevelopersQ = Redis:sismember(Sonec.."DevelopersQ:Groups",UserId) 
HELPBEVQ = Redis:sismember(Sonec.."HELPBEVQ:Groups",UserId) 
Developers = Redis:sismember(Sonec.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(Sonec.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(Sonec.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(Sonec.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Sonec.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Sonec.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Sonec.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if tonumber(UserId) == 5292559122 then
Status = 'المطور سونك' 
elseif tonumber(UserId) == 2083553704 then
Status = 'المطوره روفانا'
elseif tonumber(UserId) == 1455001649 then
Status = 'المطور باشا مصر'
elseif tonumber(UserId) == 5078690754  then
Status = 'المطور داد مصلح'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == Sonec then
Status = 'البوت'
...
Status = Redis:get(Sonec.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(Sonec.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(Sonec.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Sonec.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Sonec.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Sonec.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif Distinguished then
Status = Redis:get(Sonec.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Sonec.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Sonec.."lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❎"    
end
if Redis:get(Sonec.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❎"
end
if Redis:get(Sonec.."Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❎ "    
end
if Redis:get(Sonec.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❎ "    
end    
if Redis:get(Sonec.."Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❎ "    
end    
if Redis:get(Sonec.."Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❎ "    
end
if Redis:get(Sonec.."Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❎ "    
end
if Redis:hget(Sonec.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Sonec.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Sonec.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Sonec.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❎ "     
end
if Redis:get(Sonec.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(Sonec.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Sonec.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❎ "   
end    
if Redis:get(Sonec.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(Sonec.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❎ "    
end    
if Redis:get(Sonec.."Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(Sonec.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❎ "    
end
if Redis:get(Sonec.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(Sonec.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Sonec.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❎ "    
end
if Redis:get(Sonec.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(Sonec.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Sonec.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❎ "    
end
if Redis:get(Sonec.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(Sonec.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Sonec.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❎ "    
end
if Redis:get(Sonec.."Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(Sonec.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Sonec.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❎ "    
end 
if Redis:get(Sonec.."Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(Sonec.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❎ "    
end
if Redis:get(Sonec.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(Sonec.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❎ "    
end
if Redis:get(Sonec.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(Sonec.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❎ "    
end
if Redis:get(Sonec.."Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(Sonec.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Sonec.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❎ "    
end    
...
if Redis:get(Sonec.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(Sonec.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Sonec.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❎ "
end
if Redis:get(Sonec.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(Sonec.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Sonec.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❎ "    
end    
if Redis:get(Sonec.."Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(Sonec.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❎ "    
end    
if Redis:get(Sonec.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(Sonec.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❎ "    
end
if Redis:get(Sonec.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(Sonec.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Sonec.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❎ "    
end
if Redis:get(Sonec.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(Sonec.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❎ "    
end
if Redis:get(Sonec.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(Sonec.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Sonec.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Sonec.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❎ "    
end        
...
return{
JabwaAll = Redis:sismember(Sonec.."JabwaAll:Groups",UserId) ,
ktmall = Redis:sismember(Sonec.."ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(Sonec.."JabwaGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Sonec.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,Sonec).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(Sonec..'Channel:Join')
if Channel then
...
Redis:sadd(Sonec.."allM"..msg.chat_id, msg.id)
if Redis:get(Sonec.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(Sonec.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(Sonec.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(Sonec.."allM"..msg.chat_id)
...
Redis:del(Sonec.."allM"..msg.chat_id)
end
end
end
if tonumber(msg.sender.user_id) == tonumber(Sonec) then
...
if tonumber(msg.sender.user_id) == 5292559122 then
msg.Name_Controller = 'المطور سونك'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2083553704 then
msg.Name_Controller = 'المطوره روفانا'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1455001649 then
msg.Name_Controller = 'المطور باشا مصر'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5078690754 then
msg.Name_Controller = 'المطور داد مصلح'
msg.The_Controller = 1
...
elseif Redis:sismember(Sonec.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Sonec.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(Sonec.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Sonec.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Sonec.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Sonec.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Sonec.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Sonec.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Sonec.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Sonec.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Sonec.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Sonec.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Sonec.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Sonec.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Sonec.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Sonec.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Sonec) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Sonec.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Sonec.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Sonec.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Sonec.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Sonec.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Sonec) then
return false
end

local floods = Redis:hget(Sonec.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Sonec.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Sonec.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Sonec.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Sonec.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Sonec.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✯ قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(Sonec.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Sonec.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Sonec.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(Sonec..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(Sonec..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(Sonec..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(Sonec.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Sonec.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Sonec.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'Jabwaned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Sonec.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Sonec.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(Sonec.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Sonec.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Sonec.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Sonec.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Sonec.."lockpin"..msg_chat_id)
...
Redis:incr(Sonec.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Sonec.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Sonec.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(Sonec) then
local N = (Redis:get(Sonec.."Name:Bot") or "سونك")
photo = LuaTele.getUserProfilePhotos(Sonec)
...
Redis:set(Sonec.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(Sonec.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Sonec.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Sonec.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Sonec.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Sonec.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Sonec.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Sonec.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Sonec.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Sonec.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Sonec.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Sonec.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Sonec.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(Sonec.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Sonec.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Sonec.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Sonec.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Sonec.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Sonec..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Sonec.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Sonec.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Sonec.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Sonec.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Sonec.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Sonec.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Sonec.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Sonec.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Sonec..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✯ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Sonec..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Sonec.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Sonec.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Sonec.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Sonec..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✯ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Sonec..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Sonec.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Sonec.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Sonec.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Sonec.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Sonec.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Sonec.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Sonec.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Sonec.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Sonec..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Sonec.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.sendText(msg_chat_id,msg_id,"* ✯ لقد تم منع هذه ( "..statusfilter.." ) هنا*\n ✯ "..ReplyFilters,"md",true)   
end
end
if text and Redis:get(Sonec.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Sonec.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Sonec.."All:Get:Reides:Commands:Group"..text)
Redis:del(Sonec.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Sonec.."All:Command:List:Group",text)
...
Redis:del(Sonec.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Sonec.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Sonec.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Sonec.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Sonec.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id," ✯ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Sonec.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Sonec.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Sonec.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Sonec.."All:Command:List:Group",text)
Redis:del(Sonec.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end

if text and Redis:get(Sonec.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Sonec.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Sonec.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id," ✯ تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id," ✯ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(Sonec.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Sonec.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Sonec.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Sonec.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Sonec.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id," ✯ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Sonec.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Sonec.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Sonec.."Command:List:Group"..msg_chat_id,text)
Redis:del(Sonec.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(Sonec.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Sonec.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Sonec.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Sonec.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(Sonec.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Sonec.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Sonec.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Sonec.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم حفظ ترحيب الجروب","md",true)     
end
if Redis:get(Sonec.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Sonec.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Sonec.."Group:Rules" .. msg_chat_id,text) 
Redis:del(Sonec.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(Sonec.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Sonec.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(Sonec.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Sonec.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✯ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Sonec.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Sonec.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Sonec.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Sonec.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Sonec.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Sonec.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Sonec.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Sonec.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Sonec.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(Sonec.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Sonec.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Sonec.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✯ تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(Sonec..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Sonec.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Sonec.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✯ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Sonec.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Sonec.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Sonec.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Sonec.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Sonec.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Sonec.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Sonec.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Sonec.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Sonec.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(Sonec.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Sonec.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(Sonec.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(Sonec.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Sonec.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(Sonec.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(Sonec.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(Sonec.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(Sonec.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Sonec.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(Sonec.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(Sonec.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Sonec.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Sonec.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Sonec.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Sonec.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Sonec.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Sonec.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Sonec.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(Sonec.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(Sonec.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(Sonec.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Sonec.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Sonec.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Sonec.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Sonec.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Sonec.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Sonec.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Sonec.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id," ✯  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= Sonec then
local test = Redis:get(Sonec.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Sonec.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Sonec.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Sonec.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(Sonec.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Sonec.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(Sonec.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(Sonec.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(Sonec.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Sonec.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(Sonec.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(Sonec.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(Sonec.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Sonec.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(Sonec.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Sonec.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Sonec.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Sonec.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Sonec.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Sonec.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(Sonec..v..text)
end
Redis:del(Sonec.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Sonec.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id," ✯  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(Sonec..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(Sonec.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Sonec.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Sonec.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Sonec.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Sonec.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(Sonec.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(Sonec.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(Sonec.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(Sonec.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(Sonec.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(Sonec.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(Sonec.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Sonec..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Sonec..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(Sonec.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(Sonec.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Sonec.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Sonec.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Sonec.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Sonec.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(Sonec.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(Sonec.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(Sonec.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(Sonec.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Sonec.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(Sonec.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(Sonec.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Sonec..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(Sonec..'GetTexting:DevSonec'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '〘 الغاء الامر 〙' then 
Redis:del(Sonec..'GetTexting:DevSonec'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ✯ تم الغاء حفظ كليشة المطور')
end
Redis:set(Sonec..'Texting:DevSonec',text)
Redis:del(Sonec..'GetTexting:DevSonec'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ✯ تم حفظ كليشة المطور')
end
if Redis:get(Sonec.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✯ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Sonec.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Sonec.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Sonec.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✯ تم تعين الايدي عام',"md",true)  
end
if Redis:get(Sonec.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✯ تم الغاء امر تعين الايدي","md",true)  
Redis:del(Sonec.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Sonec.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Sonec.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✯ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Sonec.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Sonec.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✯ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Sonec.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Sonec.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ✯  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Sonec.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Sonec.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✯ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Sonec.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Sonec.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ✯  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Sonec.."Game:Smile"..msg.chat_id) then
if text == Redis:get(Sonec.."Game:Smile"..msg.chat_id) then
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Sonec.."Game:Smile"..msg.chat_id)
...
if Redis:get(Sonec.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Sonec.."Game:Monotonous"..msg.chat_id) then
Redis:del(Sonec.."Game:Monotonous"..msg.chat_id)
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Sonec.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(Sonec.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Sonec.."Game:Countrygof"..msg.chat_id)
...
if Redis:get(Sonec.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(Sonec.."Game:Riddles"..msg.chat_id) then
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Sonec.."Game:Riddles"..msg.chat_id)
...
if Redis:get(Sonec.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Sonec.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Sonec.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(Sonec.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(Sonec.."Game:Reflection"..msg.chat_id) then
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Sonec.."Game:Reflection"..msg.chat_id)
...
if Redis:get(Sonec.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ✯ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Sonec.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Sonec.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Sonec.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ✯ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Sonec.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Sonec.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Sonec.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Sonec.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Sonec.."Game:Difference"..msg.chat_id) then
if text == Redis:get(Sonec.."Game:Difference"..msg.chat_id) then 
Redis:del(Sonec.."Game:Difference"..msg.chat_id)
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Sonec.."Game:Example"..msg.chat_id) then
if text == Redis:get(Sonec.."Game:Example"..msg.chat_id) then 
Redis:del(Sonec.."Game:Example"..msg.chat_id)
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(Sonec.."All:Get:Reides:Commands:Group"..text) or Redis:get(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Sonec..'Channel:Join')}, },}}
...
if tonumber(Sonec) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,' ✯ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Sonec..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Sonec.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Sonec.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Sonec.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Sonec.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Sonec.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Sonec.."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه سونك' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✯ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Sonec) then 
return LuaTele.sendText(msg_chat_id,msg_id,' ✯ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Sonec.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Sonec.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Sonec.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Sonec.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Sonec.."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,' ✯ تم استرجاع المجموعات من نسخه سونك')
else
...
os.execute('rm -rf Sonec.lua')
os.execute('wget https://F010x/beb/Sonec.lua')
...
Redis:set(Sonec.."SendBcBot",true) 
...
Redis:set(Sonec.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Sonec.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Sonec.."AddSudosNew"..msg_chat_id)
...
local Groups = Redis:smembers(Sonec..'ChekBotAdd')  
local UsersBot = Redis:smembers(Sonec..'Num:User:Pv')  
local Get_Json = '{"BotId": '..Sonec..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Sonec.."TheBasics:Group"..v)
local Constructor = Redis:smembers(Sonec.."Originators:Group"..v)
local Manager = Redis:smembers(Sonec.."Managers:Group"..v)
local Admin = Redis:smembers(Sonec.."Addictive:Group"..v)
local Vips = Redis:smembers(Sonec.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(Sonec..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == '〘 الغاء الامر 〙' then 
Redis:del(Sonec..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(Jabwaa.id,Sonec).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✯ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Sonec..'Channel:Join',ChannelUser) 
...
Redis:set(Sonec..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:set(Sonec..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'* ✯ عدد احصائيات البوت الكامله \n⩹━━━━•✯𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒏𝒆𝒄✯•━━━━⩺\n ✯ عدد المجموعات : '..(Redis:scard(Sonec..'ChekBotAdd') or 0)..'\n ✯ عدد المشتركين : '..(Redis:scard(Sonec..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(Sonec.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Sonec..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,' ✯ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Sonec..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Sonec.."ChekBotAdd",msg_chat_id)
Redis:set(Sonec.."Status:Id"..msg_chat_id,true) ;Redis:set(Sonec.."Status:Reply"..msg_chat_id,true) ;Redis:set(Sonec.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Sonec.."Status:JabwaId"..msg_chat_id,true) ;Redis:set(Sonec.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Sonec.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Sonec.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(Sonec.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Sonec.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(Sonec.."Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(Sonec..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Sonec..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Sonec.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Sonec.."Set:Id:Groups") or Redis:get(Sonec.."Set:Id:Group"..msg_chat_id)
if Redis:get(Sonec.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Sonec..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Sonec..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Sonec.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Sonec.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(Sonec.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(Sonec.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Sonec.."allM"..msg.chat_id)  
...
Redis:del(Sonec.."Status:Del:Media"..msg.chat_id)
...
Redis:set(Sonec.."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,Sonec).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,' ✯ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Sonec).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✅ ❭' else change_info = '❬ ❎ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(Sonec.."DevelopersQ:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."DevelopersQ:Groups",Jabwaa.id) 
...
if not Redis:sismember(Sonec.."HELPBEVQ:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Sonec.."HELPBEVQ:Groups")
Redis:del(Sonec.."HELPBEVQ:Groups", Jabwaa.id)
Redis:del(Sonec.."id:HELPBEVQ:Groups", Jabwaa.id)
...
if not Redis:sismember(Sonec.."Developers:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Developers:Groups",Jabwaa.id) 
...
if not Redis:sismember(Sonec.."TheBasicsQ:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."TheBasicsQ:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(Sonec.."TheBasics:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."TheBasics:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(Sonec.."Originators:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Originators:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(Sonec.."Managers:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Managers:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(Sonec.."Addictive:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Addictive:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(Sonec.."Distinguished:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Distinguished:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(Sonec.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Sonec.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Sonec.."HELPBEVQ:Groups")
Redis:del(Sonec.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(Sonec.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(Sonec.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Sonec.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Sonec.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Sonec.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Sonec.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Sonec.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Sonec.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Sonec.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Sonec.."HELPBEVQ:Groups")
Redis:del(Sonec.."HELPBEVQ:Groups", UserId)
Redis:del(Sonec.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(Sonec.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Developers:Groups",UserId) 
...
if not Redis:sismember(Sonec.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Sonec.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Sonec.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Sonec.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Sonec.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Sonec.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Sonec.."HELPBEVQ:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(Sonec.."HELPBEVQ:Groups")
Redis:sadd(Sonec.."HELPBEVQ:Groups", UserId)
Redis:set(Sonec.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(Sonec.."Developers:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Developers:Groups",Jabwaa.id) 
...
if Redis:sismember(Sonec.."TheBasicsQ:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."TheBasicsQ:Group"..msg_chat_id,Jabwaa.id) 
...
if Redis:sismember(Sonec.."TheBasics:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."TheBasics:Group"..msg_chat_id,Jabwaa.id) 
...
if Redis:sismember(Sonec.."Originators:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Originators:Group"..msg_chat_id,Jabwaa.id) 
...
if Redis:sismember(Sonec.."Managers:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Managers:Group"..msg_chat_id,Jabwaa.id) 
...
if not msg.Originators and not Redis:get(Sonec.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Sonec.."Addictive:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Addictive:Group"..msg_chat_id,Jabwaa.id) 
...
if Redis:sismember(Sonec.."Distinguished:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Distinguished:Group"..msg_chat_id,Jabwaa.id) 
...
if Redis:sismember(Sonec.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Sonec.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Sonec.."HELPBEVQ:Groups")
Redis:sadd(Sonec.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(Sonec.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(Sonec.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Sonec.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(Sonec.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Sonec.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Sonec.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Sonec.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Sonec.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Sonec.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Sonec.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Sonec.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Sonec.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Sonec.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Sonec.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Sonec.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Sonec.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Sonec.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Sonec.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ✯ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n* ✯ قائمه مطورين البوت \n ⩹━━━━•✯𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒏𝒆𝒄✯•━━━━⩺*\n'
...
local Info_Members = Redis:smembers(Sonec.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Sonec.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Sonec.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Sonec.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Sonec.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Sonec.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Sonec.."JabwaAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Sonec.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Sonec.."JabwaGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Sonec.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Sonec.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Sonec.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Sonec.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Sonec.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(Sonec.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Sonec.."Status:JabwaId"..msg_chat_id,true) 
...
Redis:del(Sonec.."Status:Id"..msg_chat_id) 
...
Redis:del(Sonec.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Sonec.."Status:Reply"..msg_chat_id) 
...
Redis:del(Sonec.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Sonec.."Status:JabwaId"..msg_chat_id) 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Sonec.."ch:admin")
...
if not msg.Originators and not Redis:get(Sonec.."Status:JabwaId"..msg_chat_id) then
...
if Redis:sismember(Sonec.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,Jabwaa.id,'Jabwaned',0)
...
if not Redis:sismember(Sonec.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,Jabwaa.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Sonec.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(Sonec.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(Sonec.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(Sonec.."JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Sonec.."JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Sonec.."JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Sonec.."ktmAll:Groups",Message_Reply.sender.user_id) 
if Jabwa.first_name then
Jabwaiusername = '*المستخدم :- *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
Jabwaiusername = 'لا يوجد'
...
if not Redis:sismember(Sonec.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Sonec.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'Jabwaned',0)
if Jabwa.first_name then
Jabwaiusername = '*المستخدم :- *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\n ✯ تم حظره من الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if not Redis:sismember(Sonec.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Sonec.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Sonec.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if Jabwa.first_name then
Jabwaiusername = '*المستخدم :- *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
Jabwaiusername = 'لا يوجد'
...
if not Redis:sismember(Sonec.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Sonec.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if UserId == "5292559122" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرآ لا تستطيع استخدام الامر على المطور سونك *","md",true)  
end
if UserId == "2083553704" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرآ لا تستطيع استخدام الامر على المطوره روفانا *","md",true)  
end
if UserId == "1455001649" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرآ لا تستطيع استخدام الامر على المطور باشا مصر *","md",true)  
end
if UserId == "5078690754" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✯ عذرآ لا تستطيع استخدام الامر على المطور داد مصلح *","md",true)  
end
if Redis:sismember(Sonec.."JabwaAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."JabwaAll:Groups",UserId) 
...
if Redis:sismember(Sonec.."JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'Jabwaned',0)
if Jabwa.first_name then
...
if not Redis:sismember(Sonec.."JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Sonec.."JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Sonec.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Sonec.."SilentGroup:Group"..msg_chat_id,UserId) 
if Jabwa.first_name then
Jabwaiusername = '*المستخدم :- *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\n ✯ تم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
Jabwaiusername = 'لا يوجد'
...
if not Redis:sismember(Sonec.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(Sonec.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(Sonec.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Sonec.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Sonec.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Sonec.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Sonec.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Sonec.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Sonec.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Sonec.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Sonec.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Sonec.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Sonec.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(Sonec.."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Sonec.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Sonec.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local TestText = "  ❲ Developers Sonec  ❳\n— — — — — — — — —\n ✯ *Dev Name* :  [".. Jabwa.first_name.."](tg://user?id="..Sudo_Id..")\n ✯ *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
local id = Redis:get(Sonec.."id:HELPBEVQ:Groups")
...
local m = "https://t.me/S_a_i_d_i/"..Rrr..""
...
local Added_Me = Redis:get(Sonec.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
if not Redis:get(Sonec.."Vari:ous"..msg_chat_id) then
...
if Redis:get(Sonec.."lockalllll"..msg_chat_id) == "off" then
...
Redis:sadd(Sonec.."cleaner"..msg_chat_id,msg_id)
end
if text == "مسح الميديا" then 
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✯ هاذا الامر يخص⦗ '..Controller_Num(6)..' ⦘* ',"md",true)  
end
local list = Redis:smembers(Sonec.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(Sonec.."cleaner"..msg_chat_id)
...
if Redis:get(Sonec.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
if Redis:get(Sonec.."brgi"..msg.sender.user_id) == "sendbr" then
...
if Redis:get(Sonec.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(Sonec.."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(Sonec.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local Jabwa = LuaTele.getUser(msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(Sonec.."LeftBot") then
...
local zwgat_list = Redis:smembers(Sonec..msg_chat_id.."zwgat:")
...
local mutlqat_list = Redis:smembers(Sonec..msg_chat_id.."mutlqat:")
...
Redis:set(Sonec.."Lock:text"..msg_chat_id,true) 
...
Redis:set(Sonec.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Sonec.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Sonec.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Sonec.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Sonec.."lockalllll"..msg_chat_id,"off")
...
Redis:set(Sonec.."lockalllll"..msg_chat_id,"on")
...
Redis:set(Sonec.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Sonec.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(Sonec.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Sonec..''..lock..msg_chat_id,"del")    
end
...
Redis:del(Sonec.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Sonec.."Lock:text"..msg_chat_id)  
...
Redis:del(Sonec.."Lock:Join"..msg_chat_id)  
...
Redis:del(Sonec.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Sonec.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(Sonec.."lockpin"..msg_chat_id)  
...
Redis:del(Sonec.."Lock:edit"..msg_chat_id) 
...
Redis:del(Sonec.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Sonec..''..lock..msg_chat_id)    
end
...
Redis:hset(Sonec.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Sonec.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Sonec.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Sonec.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Sonec.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Sonec.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Link"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(Sonec..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(Sonec..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✯ تم قفـل السب").Lock,"md",true)  
end
if text == 'قفل السونكيه'  then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✯ هاذا الامر يخص⦗ '..Controller_Num(7)..' ⦘* ',"md",true)  
end
Redis:set(Sonec..'lock:Fars'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✯ تم قفـل السونكيه").Lock,"md",true)  
end
if text == 'فتح السب' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✯ هاذا الامر يخص⦗ '..Controller_Num(7)..' ⦘* ',"md",true)  
end
Redis:del(Sonec..'lock:Fshar'..msg.chat_id) 
...
Redis:del(Sonec..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✯ تم فتح السب").unLock,"md",true)  
end
if text == 'فتح السونكيه' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✯ هاذا الامر يخص⦗ '..Controller_Num(7)..' ⦘* ',"md",true)  
end
Redis:del(Sonec..'lock:Fars'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✯ تم فتح السونكيه").unLock,"md",true)  
end
...
Redis:del(Sonec.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Photo"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Video"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Animation"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:geam"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Audio"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:vico"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:forward"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Document"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Contact"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Spam"..msg_chat_id)  
...
Redis:set(Sonec.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Sonec.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Sonec.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Sonec.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Sonec.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Sonec.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(Sonec.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Sonec.."Status:Welcome"..msg_chat_id) then
...
Redis:del(Sonec.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(Sonec.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Sonec.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Sonec.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Sonec.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Sonec.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Sonec.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Sonec.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(Sonec.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Sonec.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Sonec..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Sonec..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✯ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Sonec.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Sonec.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Sonec.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Sonec.."All:Get:Reides:Commands:Group"..v)
Redis:del(Sonec.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Sonec.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Sonec.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ✯ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(Sonec.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ✯ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Sonec.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Sonec.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(Sonec.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✅ ❭' else Statuslink = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✅ ❭' else StatusWelcome = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✅ ❭' else StatusId = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✅ ❭' else StatusIdPhoto = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✅ ❭' else StatusReplySudo = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:JabwaId"..msg.chat_id)  then
StatusJabwaId = '❬ ✅ ❭' else StatusJabwaId = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✅ ❭' else StatusSetId = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✅ ❭' else StatusGames = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✅ ❭' else Statuskickme = '❬ ❎ ❭'
end
if Redis:get(Sonec.."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒏𝒆𝒄', url = 't.me/sonek_2'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(Sonec.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Sonec.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Sonec.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Sonec.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Sonec.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Sonec.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(Sonec.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(Sonec.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(Sonec.."DevelopersQ:Groups",Jabwaa.id)  then
Rink = 2
elseif Redis:sismember(Sonec.."Developers:Groups",Jabwaa.id)  then
Rink = 3
elseif Redis:sismember(Sonec.."TheBasicsQ:Group"..msg_chat_id, Jabwaa.id) then
Rink = 4
elseif Redis:sismember(Sonec.."TheBasics:Group"..msg_chat_id, Jabwaa.id) then
Rink = 5
elseif Redis:sismember(Sonec.."Originators:Group"..msg_chat_id, Jabwaa.id) then
Rink = 6
elseif Redis:sismember(Sonec.."Managers:Group"..msg_chat_id, Jabwaa.id) then
Rink = 7
elseif Redis:sismember(Sonec.."Addictive:Group"..msg_chat_id, Jabwaa.id) then
Rink = 8
elseif Redis:sismember(Sonec.."Distinguished:Group"..msg_chat_id, Jabwaa.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(Sonec..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,' ✯ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Sonec..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,' ✯ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Sonec..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,' ✯ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,' ✯ عدد رسائلك هنا *~ '..(Redis:get(Sonec..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,' ✯ عدد التعديلات هنا *~ '..(Redis:get(Sonec..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,' ✯ عدد جهاتك المضافه هنا *~ '..(Redis:get(Sonec.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Sonec.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✯ ارسل الان النص
 ✯ يمكنك اضافه :
...
Redis:setex(Sonec.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✯ ارسل الان النص
 ✯ يمكنك اضافه :
 ✯ `#username` » اسم المستخدم
...
Redis:del(Sonec.."Set:Id:Group"..msg.chat_id)
...
Redis:del(Sonec.."DevelopersQ:Groups") 
...
Redis:del(Sonec.."Developers:Groups") 
...
Redis:del(Sonec.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(Sonec.."Originators:Group"..msg_chat_id) 
...
Redis:del(Sonec.."Managers:Group"..msg_chat_id) 
...
Redis:del(Sonec.."Addictive:Group"..msg_chat_id) 
...
Redis:del(Sonec.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(Sonec.."JabwaAll:Groups") 
...
Redis:del(Sonec.."JabwaGroup:Group"..msg_chat_id) 
...
Redis:del(Sonec.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Sonec.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Sonec.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Sonec.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Sonec.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Sonec.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Sonec.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Sonec.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Sonec.."List:Manager"..msg_chat_id)
end
...
text = " ✯ قائمه الردود \n⩹━━━━•✯𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒏𝒆𝒄✯•━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(Sonec.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Sonec.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Sonec.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Sonec.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Sonec.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Sonec.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Sonec.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ✯ "
elseif Redis:get(Sonec.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Sonec.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Sonec.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Sonec.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id," ✯ ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(Sonec.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(Sonec.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(Sonec.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Sonec.."Add:Rd:Sudo:Gif"..v)   
Redis:del(Sonec.."Add:Rd:Sudo:vico"..v)   
Redis:del(Sonec.."Add:Rd:Sudo:stekr"..v)     
Redis:del(Sonec.."Add:Rd:Sudo:Text"..v)   
Redis:del(Sonec.."Add:Rd:Sudo:Photoc"..v)
Redis:del(Sonec.."Add:Rd:Sudo:Photo"..v)
Redis:del(Sonec.."Add:Rd:Sudo:Video"..v)
Redis:del(Sonec.."Add:Rd:Sudo:File"..v)
Redis:del(Sonec.."Add:Rd:Sudo:Audio"..v)
Redis:del(Sonec.."Add:Rd:Sudo:video_note"..v)
Redis:del(Sonec.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \n⩹━━━━•✯𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒏𝒆𝒄✯•━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(Sonec.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Sonec.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Sonec.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Sonec.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Sonec.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Sonec.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Sonec.."Add:Rd:Sudo:File"..v) then
db = "ملف ✯ "
elseif Redis:get(Sonec.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Sonec.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Sonec.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Sonec.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(Sonec.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✯ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Sonec..'Channel:Join')}, },}}
...
Redis:setex(Sonec.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Sonec.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Sonec.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Sonec.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Sonec.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Sonec..'GetTexting:DevSonec'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Sonec..'Texting:DevSonec')
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒏𝒆𝒄',url="https://t.me/sonek_2"}}
}
local msg_id = msg.id/2097152/0.5
...
video = "https://t.me/sonek_2/774"
local T =[[
⦑〘مرحب بيكك في سسؤرسس سسؤنك〙〉
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐁𝐀𝐒𝐇𝐀 𝐌𝐀𝐒𝐑', url = "https://t.me/Sonek01"},{text = '𝐒𝐎𝐍𝐄𝐂 𝐄𝐋𝐊𝐀𝐁𝐄𝐑', url = "https://t.me/G1C0N"}
},
{
{text = '𝐑𝐎𝐕𝐀𝐍𝐀', url = "https://t.me/Rovanaas"},{text = '𝐃𝐀𝐃 𝐌𝐄𝐒𝐋𝐄7', url = "https://t.me/Dad_mesle7"}
},
{
{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒏𝒆𝒄',url = "https://t.me/sonek_2"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'سونك' or text == 'سونك الكبير' or text == 'المطور سونك' then
photo = "https://t.me/G1C0N"
local Name = 'المطور سونك الكبير اتبع الازرار لتواصل معاه ☑️. '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐒𝐎𝐍𝐄𝐂 𝐄𝐋𝐊𝐀𝐁𝐄𝐑',url = "https://t.me/G1C0N"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'روفانا' or text == 'روفان' or text == 'المطوره روفانا' then
photo = "https://t.me/Rovanaas"
local Name = 'المطوره روفانا اتبع الازرار لتواصل معاه ☑️. '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐑𝐎𝐕𝐀𝐍𝐀', url = "https://t.me/Rovanaas"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'باشا مصر' or text == 'باشا' or text == 'المطور باشا مصر' then
photo = "https://t.me/Sonek01"
local Name = 'المطور باشا مصر اتبع الازرار لتواصل معاه ☑️. '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐁𝐀𝐒𝐇𝐀 𝐌𝐀𝐒', url = "https://t.me/Sonek01"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'داد مصلح' or text == 'مصلح' or text == 'المطور داد مصلح' then
photo = "https://t.me/Dad_mesle7"
local Name = ' المطور داد مصلح اتبع الازرار لتواصل معاه ☑️. '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐃𝐀𝐃 𝐌𝐄𝐒𝐋𝐄7', url = "https://t.me/Dad_mesle7"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(Message_Reply.sender.user_id) == tonumber(Sonec) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يبنوسخه 😒*","md",true)  
end
if Redis:sismember(Sonec..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(Sonec..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(Sonec..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(Sonec..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(Sonec..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(Sonec..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(Sonec..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
Redis:setex(Sonec.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Sonec.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id," ✯ تم حذف اسم البوت ","md",true)   
end
if text == 'بوت' or text == 'البوت' then
local photo = LuaTele.getUserProfilePhotos(Sonec)
local Jabwa = LuaTele.getUser(Sonec)
local Namebot = (Redis:get(Sonec.."Name:Bot") or "سونك")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NameBots, url = 't.me/sonek_2'}, 
},
{
{text = 'اضف البوت الي مجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
if text == (Redis:get(Sonec.."Name:Bot") or "سونك") then
local photo = LuaTele.getUserProfilePhotos(Sonec)
local Jabwa = LuaTele.getUser(Sonec)
local Namebot = (Redis:get(Sonec.."Name:Bot") or "سونك")
local BotName = {
...
x = x + 1
Redis:srem(Sonec..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Sonec)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'* ✯ البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(Sonec..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Sonec..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Sonec..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Sonec..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Sonec.."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(Sonec.."Status:Games"..msg.chat_id) then
Redis:del(Sonec.."Set:Country"..msg.chat_id)
...
Redis:set(Sonec.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(Sonec.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Sonec.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Sonec.."Status:Games"..msg.chat_id) then
Redis:del(Sonec.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Sonec.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Sonec.."Status:Games"..msg.chat_id) then
Redis:del(Sonec.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Sonec.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(Sonec.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Sonec.."Game:Difference"..msg.chat_id,name)
...
Redis:set(Sonec.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Sonec.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Sonec.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Sonec.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Sonec.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Sonec.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local Jabwa = LuaTele.getUser(Sonec)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(Sonec..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Sonec.."Start:Bot") then
...
local CmdStart = '*\n ✯ أهلا بك في بوت '..(Redis:get(Sonec.."Sonec:Name:Bot") or "سونك")..
...
keyboard.inline_keyboard = {
{
{text = '•سسؤنكك ، آلككبير•', url = 't.me/G1C0N'},{text = '•رؤفآنآ•', url = 't.me/Rovanaas'}, 
},
{
{text = '•بآشآ ، مٓ ـصر•', url = 't.me/Sonek01'},{text = '•دآد ، مٓ ـصلح ـ•', url = 't.me/Dad_mesle7'}, 
},
{
{text = '•بۅت تۅآصݪ•', url = 't.me/Sonek_elkeber_bot'}, 
},
{
{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒏𝒆𝒄', url = 't.me/sonek_2'}, 
},
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Sonec.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
Redis:setex(Sonec.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(Sonec.."TwaslBot") and not Redis:sismember(Sonec.."Jabwa:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Sonec.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Sonec.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Sonec..'Jabwa:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' ✯ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Sonec..'Jabwa:In:Tuasl',Info_User)  
...
Redis:srem(Sonec.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Sonec..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Sonec.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(Sonec.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Sonec.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Sonec.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Sonec.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Sonec.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Sonec.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Sonec.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Sonec.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Sonec.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Sonec.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Sonec.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Sonec.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Sonec.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Sonec.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Sonec.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Sonec.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Sonec.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Sonec.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Sonec.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Sonec.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(Sonec) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Sonec..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == Sonec then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Sonec..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Sonec.."Lock:edit"..data.chat_id) then
...
Redis:incrby(Sonec.."Num:Add:Games"..ChatId..IdUser, 1)  
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس سونك اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس سونك 
...
Redis:set(Sonec.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"* ✯ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(Sonec.."zhrfa"..IdUser,"sendzh") 
...
Redis:set(Sonec.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(Sonec.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Sonec.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Sonec.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Sonec.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Sonec.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Vari:ous"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," ✯ تم تعطيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:JabwaId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:JabwaId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Vari:ous"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Sonec.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," ✯ تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Sonec.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Sonec.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Sonec.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Sonec..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(Sonec.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Sonec..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, " ✯ تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع ??', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Sonec.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Sonec.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع 🔙', data =UserId..'/'.. 'NoNextSeting'},},}}
